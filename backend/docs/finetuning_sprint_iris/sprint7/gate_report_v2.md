...
| G1.1 | multi-turn ≥15% | 47.9% | 15% | BLOCKER | ✅ |
| G1.2 | persona Q&A ≥750 OR ≥7.5% | 93 (3.7%) | ≥750 OR ≥7.5% | BLOCKER | ❌ |
| G1.3 | adversarial ≥200 OR ≥2% (WARNING v1) | 3 (0.1%) | ≥200 OR ≥2% | WARNING | ⚠️ |
| G1.4 | DM single-turn ≤75% | 48.3% | 75% | WARNING | ✅ |
| G2.1 | error strings = 0 | 0 | 0 | BLOCKER | ✅ |
| G2.2 | solo-artifact = 0 | 0 | 0 | BLOCKER | ✅ |
| G2.3 | artifacts explícitos <2% | 19.4% | 2% | BLOCKER | ❌ |
| G2.4 | duplicados exactos <5% | 7.1% | 5% | WARNING | ⚠️ |
| G2.5 | respuestas <10chars <5% | 2.0% | 5% | WARNING | ✅ |
| G3.1 | Distinct-1 ≥0.20 | 13.0% | 20% | WARNING | ⚠️ |
| G3.2 | Distinct-2 ≥0.40 | 47.8% | 40% | WARNING | ✅ |
| G3.3 | Self-BLEU-4 ≤0.65 | 0.0% | 65% | WARNING | ✅ |
| G4.1 | categorías persona ≥5/6 | 6/6 | ≥5/6 | WARNING | ✅ |
| G4.2 | idioma ca+es ≥35% | 25.5% | 35% | WARNING | ⚠️ |
| G5.1 | coherencia ≥85% (heurística) | 92.5% | 85% | WARNING | ✅ |
| G6.2 | PII en assistant = 0 | 0 | 0 | BLOCKER | ✅ |
| G6.1 | overlap CCEE eval = 0 | 0 | 0 | BLOCKER | ✅ |
| G8.1 | N mínimo ≥2,000 | 2533 | 2000 | BLOCKER | ✅ |
| G8.2 | N máximo ≤30,000 | 2533 | 30000 | WARNING | ✅ |
...
- **G1.2** persona Q&A ≥750 OR ≥7.5%: `93 (3.7%)` (threshold: ≥750 OR ≥7.5%)
- **G2.3** artifacts explícitos <2%: `19.4%` (threshold: 2%)

### Warnings (training permitido pero documentar)
- **G1.3** adversarial ≥200 OR ≥2% (WARNING v1): `3 (0.1%)` (threshold: ≥200 OR ≥2%)
- **G2.4** duplicados exactos <5%: `7.1%` (threshold: 5%)
- **G3.1** Distinct-1 ≥0.20: `13.0%` (threshold: 20%)
- **G4.2** idioma ca+es ≥35%: `25.5%` (threshold: 35%)

...
ACHIEVEMENTS = [
    ...
    {"id": "ten_approvals", "name": "Racha de 10", "icon": "🔟", "description": "Aprueba 10 sugerencias", "check": lambda d: d["approved"] >= 10},
    ...
    {"id": "first_rule", "name": "Primera regla", "icon": "📏", "description": "Tu clon aprendió su primera regla", "check": lambda d: d["total_rules"] >= 1},
    {"id": "five_rules", "name": "Cinco reglas", "icon": "📚", "description": "Tu clon tiene 5 reglas aprendidas", "check": lambda d: d["total_rules"] >= 5},
    {"id": "streak_3", "name": "Racha de 3 días", "icon": "🔥", "description": "Usa el copiloto 3 días seguidos", "check": lambda d: d["streak"] >= 3},
    {"id": "streak_7", "name": "Semana perfecta", "icon": "🗓️", "description": "Usa el copiloto 7 días seguidos", "check": lambda d: d["streak"] >= 7},
    {"id": "level_3", "name": "Aprendiz", "icon": "📘", "description": "Alcanza el nivel Aprendiz (100 XP)", "check": lambda d: d["xp"] >= 100},
    {"id": "level_5", "name": "Hábil", "icon": "🎯", "description": "Alcanza el nivel Hábil (500 XP)", "check": lambda d: d["xp"] >= 500},
    {"id": "autopilot_ready", "name": "Piloto automático", "icon": "🚀", "description": "Un intent alcanza status 'ready'", "check": lambda d: d["has_ready_intent"]},
]

...
class Prediction(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    creator_id = Column(String(100), nullable=False, index=True)
    prediction_type = Column(String(50), nullable=False)  # conversion, churn, revenue, engagement, best_time
...
class DetectedTopic(Base):
    ...
    topic_type = Column(String(50), default="general")  # question, objection, interest, complaint, suggestion

"""
Website ingestion endpoints for Ingestion V2 API.

Endpoints:
- POST /website — Full website ingestion with zero-hallucination guarantees
- POST /preview — Preview detection without saving
- GET /verify/{creator_id} — Verify stored products for a creator
"""

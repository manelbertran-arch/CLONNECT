...
# Decomposed modules — re-export for backward compatibility
from core.dm.text_utils import (  # noqa: E402
    _strip_accents,
...
from core.dm.models import (  # noqa: E402
    AgentConfig,
    DMResponse,
    DetectionResult,
    ContextBundle,
...
# (text_utils, NON_CACHEABLE_INTENTS, apply_voseo moved to core.dm.text_utils)


# (AgentConfig, DMResponse, DetectionResult, ContextBundle moved to core.dm.models)


# (_determine_response_strategy moved to core.dm.strategy)
